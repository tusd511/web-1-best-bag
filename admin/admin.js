...
function createordertable(){
    var orders = [
        { id: 1, email: 'aabernathy@yahoo.com', details: 'Pizza Hải Sản Nhiệt Đới (XL x1), Mỳ Ý Cay Hải Sản (x1)', date: '21/11/2020 7:28:32 AM', total: '268.000đ', confirmed: true },
        { id: 2, email: 'king.beaulah@cole.biz', details: 'Mỳ Ý Thịt Bò Băm (x1), Salad Trộn Ceasar (x1)', date: '21/11/2020 7:28:32 AM', total: '198.000đ', confirmed: true },
        { id: 3, email: 'beier.craig@hotmail.com', details: 'Tiết kiệm 50% Pizza (x1)', date: '22/11/2020 8:22:12 AM', total: '297.000đ', confirmed: false },
        { id: 4, email: 'john.doe@example.com', details: 'Pizza Pepperoni (x2), Coca-Cola (x2)', date: '23/11/2020 5:15:45 PM', total: '326.000đ', confirmed: true }, 
        { id: 5, email: 'jane.smith@example.com', details: 'Pizza Margherita (M x1), Nước cam (x1)', date: '24/11/2020 11:00:00 AM', total: '175.000đ', confirmed: true }, 
        { id: 6, email: 'alex.jones@example.com', details: 'Burger Bò (x2), Khoai Tây Chiên (x2)', date: '25/11/2020 1:47:29 PM', total: '220.000đ', confirmed: false}
    ];
    ...
    for( var i = 0; i<orders.length;i++) {
        s += `
            <tr>
                ...
                <td><input type="checkbox" ${orders[i].confirmed ? 'checked' : ''}></td>
            </tr>
        `;
    }
...
//xử lý phân trang và tạo bảng người dùng
    let accounts = [
        { id: 1, email: 'john.doe1@example.com', password: 'password123', createdDate: '2023-01-01', isActive: true },
        { id: 2, email: 'jane.smith2@example.com', password: 'password123', createdDate: '2023-01-05', isActive: false },
        { id: 3, email: 'billy.joe3@example.com', password: 'password123', createdDate: '2023-02-10', isActive: true },
        { id: 4, email: 'nancy.drew4@example.com', password: 'password123', createdDate: '2023-02-14', isActive: false },
        { id: 5, email: 'jack.black5@example.com', password: 'password123', createdDate: '2023-03-01', isActive: true },
        { id: 6, email: 'amanda.wong6@example.com', password: 'password123', createdDate: '2023-03-03', isActive: true },
        { id: 7, email: 'robert.lee7@example.com', password: 'password123', createdDate: '2023-04-15', isActive: false },
        { id: 8, email: 'kim.fields8@example.com', password: 'password123', createdDate: '2023-04-18', isActive: true },
        { id: 9, email: 'chris.rock9@example.com', password: 'password123', createdDate: '2023-05-20', isActive: false },
        { id: 10, email: 'julia.moore10@example.com', password: 'password123', createdDate: '2023-06-02', isActive: true },
        { id: 11, email: 'henry.wood11@example.com', password: 'password123', createdDate: '2023-06-12', isActive: false },
        { id: 12, email: 'olivia.stone12@example.com', password: 'password123', createdDate: '2023-07-08', isActive: true },
        { id: 13, email: 'david.james13@example.com', password: 'password123', createdDate: '2023-07-15', isActive: true },
        { id: 14, email: 'emily.white14@example.com', password: 'password123', createdDate: '2023-08-01', isActive: false },
        { id: 15, email: 'sophia.green15@example.com', password: 'password123', createdDate: '2023-08-10', isActive: true },
        { id: 16, email: 'lucas.wright16@example.com', password: 'password123', createdDate: '2023-09-05', isActive: true },
        { id: 17, email: 'amelia.king17@example.com', password: 'password123', createdDate: '2023-09-20', isActive: false },
        { id: 18, email: 'michael.brown18@example.com', password: 'password123', createdDate: '2023-10-01', isActive: true },
        { id: 19, email: 'emma.jones19@example.com', password: 'password123', createdDate: '2023-10-10', isActive: false },
        { id: 20, email: 'logan.miller20@example.com', password: 'password123', createdDate: '2023-11-02', isActive: true },
        { id: 21, email: 'ava.davis21@example.com', password: 'password123', createdDate: '2023-11-15', isActive: true },
        { id: 22, email: 'liam.wilson22@example.com', password: 'password123', createdDate: '2023-12-05', isActive: false },
        { id: 23, email: 'mia.harris23@example.com', password: 'password123', createdDate: '2023-12-10', isActive: true },
        { id: 24, email: 'ethan.clark24@example.com', password: 'password123', createdDate: '2024-01-01', isActive: false },
        { id: 25, email: 'chloe.walker25@example.com', password: 'password123', createdDate: '2024-01-15', isActive: true },
        { id: 26, email: 'noah.young26@example.com', password: 'password123', createdDate: '2024-02-01', isActive: true },
        { id: 27, email: 'lily.allen27@example.com', password: 'password123', createdDate: '2024-02-10', isActive: false },
        { id: 28, email: 'william.hall28@example.com', password: 'password123', createdDate: '2024-03-01', isActive: true },
        { id: 29, email: 'zoe.baker29@example.com', password: 'password123', createdDate: '2024-03-15', isActive: true },
        { id: 30, email: 'james.carter30@example.com', password: 'password123', createdDate: '2024-04-01', isActive: false },
        { id: 31, email: 'grace.white31@example.com', password: 'password123', createdDate: '2024-04-10', isActive: true },
        { id: 32, email: 'oliver.martin32@example.com', password: 'password123', createdDate: '2024-04-12', isActive: false },
        { id: 33, email: 'benjamin.lee33@example.com', password: 'password123', createdDate: '2024-05-01', isActive: true },
        { id: 34, email: 'emily.garcia34@example.com', password: 'password123', createdDate: '2024-05-05', isActive: true },
        { id: 35, email: 'matthew.moore35@example.com', password: 'password123', createdDate: '2024-06-10', isActive: false },
        { id: 36, email: 'samantha.kelly36@example.com', password: 'password123', createdDate: '2024-06-15', isActive: true },
        { id: 37, email: 'dylan.perez37@example.com', password: 'password123', createdDate: '2024-07-01', isActive: false },
        { id: 38, email: 'luke.evans38@example.com', password: 'password123', createdDate: '2024-07-15', isActive: true },
        { id: 39, email: 'joseph.young39@example.com', password: 'password123', createdDate: '2024-08-01', isActive: true },
        { id: 40, email: 'rachel.hall40@example.com', password: 'password123', createdDate: '2024-08-20', isActive: false },
        { id: 41, email: 'william.moore41@example.com', password: 'password123', createdDate: '2024-09-01', isActive: true },
        { id: 42, email: 'chris.taylor42@example.com', password: 'password123', createdDate: '2024-09-10', isActive: false },
        { id: 43, email: 'anna.wright43@example.com', password: 'password123', createdDate: '2024-09-25', isActive: true },
        { id: 44, email: 'lillian.davis44@example.com', password: 'password123', createdDate: '2024-10-05', isActive: true },
        { id: 45, email: 'jackson.white45@example.com', password: 'password123', createdDate: '2024-10-10', isActive: false },
        { id: 46, email: 'sofia.martin46@example.com', password: 'password123', createdDate: '2024-11-01', isActive: true },
        { id: 47, email: 'nathan.smith47@example.com', password: 'password123', createdDate: '2024-11-05', isActive: true },
        { id: 48, email: 'chloe.johnson48@example.com', password: 'password123', createdDate: '2024-12-01', isActive: false },
        { id: 49, email: 'leo.lee49@example.com', password: 'password123', createdDate: '2024-12-10', isActive: true },
        { id: 50, email: 'olivia.miller50@example.com', password: 'password123', createdDate: '2024-12-15', isActive: false },
        { id: 51, email: 'joseph.harris51@example.com', password: 'password123', createdDate: '2025-01-05', isActive: true },
        { id: 52, email: 'victoria.davis52@example.com', password: 'password123', createdDate: '2025-01-10', isActive: true },
        { id: 53, email: 'katherine.moore53@example.com', password: 'password123', createdDate: '2025-02-01', isActive: false },
        { id: 54, email: 'michael.wilson54@example.com', password: 'password123', createdDate: '2025-02-15', isActive: true },
        { id: 55, email: 'lily.garcia55@example.com', password: 'password123', createdDate: '2025-03-01', isActive: true },
        { id: 56, email: 'jacob.white56@example.com', password: 'password123', createdDate: '2025-03-10', isActive: false },
        { id: 57, email: 'ella.kim57@example.com', password: 'password123', createdDate: '2025-04-01', isActive: true },
        { id: 58, email: 'aiden.davis58@example.com', password: 'password123', createdDate: '2025-04-15', isActive: true },
        { id: 59, email: 'grayson.smith59@example.com', password: 'password123', createdDate: '2025-05-01', isActive: false },
        { id: 60, email: 'leah.jones60@example.com', password: 'password123', createdDate: '2025-05-05', isActive: true },
        { id: 61, email: 'charlotte.miller61@example.com', password: 'password123', createdDate: '2025-06-01', isActive: true },
        { id: 62, email: 'liam.brown62@example.com', password: 'password123', createdDate: '2025-06-15', isActive: false },
        { id: 63, email: 'harper.wilson63@example.com', password: 'password123', createdDate: '2025-07-01', isActive: true },
        { id: 64, email: 'zachary.moore64@example.com', password: 'password123', createdDate: '2025-07-10', isActive: true }
    ]
    ...
    function renderPageNumber(){
        ...
        for(let i=1;i<=totalPage;i++){
            paginationHTML += `<li class="pagination-user-item">
                                    <button class="pagination-button ${currentPage===i?' selected-page':''}" onclick="handlePageNumber(${i})">${i}</button>
                                </li>` ;
        }
        paginationHTML +=`<li class="pagination-user-item">
    ...
    function renderAccount(){
        ...
        for(var i=0;i<perAccounts.length;i++){
            ...
            if(perAccounts[i].isActive){
                active='<i class="fas fa-check-circle color-green" onclick="kichHoat(this);"></i>';
            }else{
                active='<i class="fas fa-check-circle" onclick="kichHoat(this);"></i>';
                rowStyle='style="background-color: rgba(255,0,0,0.3); text-decoration: line-through;"';
            }
            s +=`
                <tr ${rowStyle}>
